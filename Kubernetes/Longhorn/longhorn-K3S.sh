...
longhorn1=192.168.1.220
longhorn2=192.168.1.221
longhorn3=192.168.1.222
...
kubectl apply -f https://raw.githubusercontent.com/zarnautovic/home-server/refs/heads/main/Kubernetes/Longhorn/longhorn.yaml 
kubectl get pods \
